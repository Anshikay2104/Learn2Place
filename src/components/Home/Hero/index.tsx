                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 items-center'>
                    <div className='col-span-6 flex flex-col gap-8 '>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            ...
                            />
                            <p className='text-success text-sm font-semibold text-center lg:text-start'>Get in touch with the amazing Alumni !!</p>
                        </div>
                        <h1 className='text-midnight_text text-4xl sm:text-5xl font-semibold pt-5 lg:pt-0'>Advance your career opportunities with us.</h1>
                        <h3 className='text-black/70 text-lg pt-5 lg:pt-0'>Build skills with our resources and alumni experiences from world-class companies.</h3>
                        <div className="relative rounded-full pt-5 lg:pt-0">
                            <input type="Email address" name="q" className="py-6 lg:py-8 pl-8 pr-20 text-lg w-full text-black rounded-full focus:outline-none shadow-input-shadow" placeholder="search ..." autoComplete="off" />
